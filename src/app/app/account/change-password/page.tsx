    ...
    <div className="max-w-lg space-y-4">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="card p-4 space-y-4 bg-white/5 border-white/10">
        <div>
          ...
          <input id="currentPassword" type="password" className="w-full rounded-xl border px-3 py-2 bg-transparent" aria-invalid={!!errors.currentPassword} {...register("currentPassword")} />
          {errors.currentPassword && <p role="alert" className="text-sm text-red-400 mt-1">{errors.currentPassword.message}</p>}
        </div>
        <div>
