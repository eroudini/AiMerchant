    ...
    <div className="max-w-lg space-y-4">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="card p-4 space-y-4">
        <div>
          ...
          <input id="newEmail" type="email" className="w-full rounded-xl border px-3 py-2" aria-invalid={!!errors.newEmail} {...register("newEmail")} />
          {errors.newEmail && <p role="alert" className="text-sm text-red-600 mt-1">{errors.newEmail.message}</p>}
        </div>
