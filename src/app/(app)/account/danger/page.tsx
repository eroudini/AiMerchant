  ...
  return (
    <div className="max-w-lg space-y-4">
      ...
      <div className="border border-red-200 bg-red-50 rounded-2xl p-4">
        <h2 className="font-medium mb-1">Supprimer le compte</h2>
        <p className="text-sm text-red-700 mb-3">Cette action est irréversible et supprimera vos données (démo).</p>
        <button onClick={onDelete} className="inline-flex items-center justify-center rounded-xl bg-red-600 px-4 py-2 text-white hover:bg-red-700">
