...
export default function PricingPage() {
  return (
    <>
      <Navbar />
      <main className="px-6 sm:px-8 lg:px-12 py-16 max-w-7xl mx-auto">
  ...
  <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="border rounded-2xl p-8 bg-white flex flex-col shadow-sm">
          ...
          <p className="text-xs text-gray-600 mb-5">Pour découvrir et tester avant engagement.</p>
        ...
        {/* Pro */}
        <div className="border rounded-2xl p-8 bg-[#0B0B0F] text-white flex flex-col relative overflow-hidden">
          <div
          ...
          <p className="text-xs text-gray-300 mb-5 relative">Automatisations & accélération décisionnelle.</p>
            ...
            <tbody>
              {[
                ...
                <tr key={row[0]} className="border-t">
                  ...
                  <td className="px-4 py-3 text-gray-900">{row[2]}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <div className="mt-24 text-center">
        ...
        <p className="text-sm text-gray-600 mb-6">Créez votre compte en moins de 2 minutes et commencez à explorer vos opportunités.</p>
        <Link
          href="/register"
