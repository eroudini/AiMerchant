...
export default async function DashboardPage() {
  ...
  try {
    radarProduct = await getRadarTrends({ period: 'last_30d', type: 'product', country, limit: 100, cookie: cookieHeader });
  } catch {}
  try {
    radarCategory = await getRadarTrends({ period: 'last_30d', type: 'category', country, limit: 100, cookie: cookieHeader });
  } catch {}
